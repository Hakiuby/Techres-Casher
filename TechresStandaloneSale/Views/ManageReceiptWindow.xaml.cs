...
{
    /// <summary>
    /// Interaction logic for ManageReceiptWindow.xaml
    /// </summary>
    public partial class ManageReceiptWindow : Window
    {
        public ManageReceiptWindow()
        {
            InitializeComponent();
        }
        ...
        private void Amount_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            //    if (number < 0)
            //    {
            //        amount.SelectionStart = number + 1;
            //    }
            //    else
            //    {
        ...
        private void ManagePaymentSlipWindow_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.F3)
            {
                if (objectType.Visibility == Visibility.Visible)
                {
            ...
            {
                if (DockBranchItem.Visibility == Visibility.Visible)
                {
                    branchItem.Focus();
